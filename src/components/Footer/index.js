...
import { faTwitter, faInstagram, faFacebook, faSnapchat, faLinkedin, faYoutube } from "@fortawesome/free-brands-svg-icons";
import "./Footer.scss";
  ...
  return (
    <footer>
      <div className="container" id="footer__container">
        <div className="footer__apps row mt-5">
          <a
        ...
        <div className="footer__list row">
          <div className="footer__list-item col-lg-3 mb-5">
            ...
            <a className="footer__list-link" href="https://www.finnkino.fi/en/teatterit">Cinemas </a> 
            <a className="footer__list-link" href="http://www.finnkinob2b.fi/">B2B </a> 
            <a className="footer__list-link" href="https://www.finnkino.fi/en/rekry">Jobs </a> 
            <a className="footer__list-link" href="https://www.finnkino.fi/en/tietoa-finnkinosta">Finnkino Oy</a> 
          </div>
          <div className="footer__list-item col-lg-3 mb-5">
            <p className="footer__list-title">Customer service</p>
            <a className="footer__list-link" href="https://www.finnkino.fi/en/asiakaspalvelu/">Contact us </a> 
            <a className="footer__list-link" href="https://www.finnkino.fi/en/faq">FAQ </a> 
          </div>
          <div className="footer__list-item col-lg-3 mb-5">
            <p className="footer__list-title">Web shop</p>
            <a className="footer__list-link" href="https://www.finnkino.fi/en/tietosuoja">Privacy</a> 
            <a className="footer__list-link" href="https://www.finnkino.fi/en/verkkokauppa/verkkokaupan-kayttoehdot">Terms and conditions </a> 
            <a className="footer__list-link" href="https://www.finnkino.fi/en/verkkokauppa/finnkino-lab-ehdot">Terms of Finnkino Lab </a> 
          </div>
        ...
        <div className="footer__sponsors pt-4">
